...
public class Constants {
    ...
    public static class ObjectConstants {
        ...
        public final static int SPIKE_WIDTH_DEFAULT = 32;
        public final static int SPIKE_HEIGHT_DEFAULT = 32;
        public final static int SPIKE_WIDTH = (int)(Game.SCALE*SPIKE_WIDTH_DEFAULT);
        public final static int SPIKE_HEIGHT = (int)(Game.SCALE*SPIKE_HEIGHT_DEFAULT);
